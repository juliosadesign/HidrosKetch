  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-10 flex items-center justify-center p-6">
      <section className="pointer-events-auto w-full max-w-3xl rounded-3xl border border-cyan-500/30 bg-slate-950/90 p-6 shadow-2xl shadow-cyan-950/30 backdrop-blur">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-xl text-sm leading-6 text-slate-300">
              Monte redes hidráulicas de forma visual, estime perdas de carga,
              altura manométrica, potência da bomba, consumo mensal, custo de
              energia e faça uma pré-seleção didática de bombas.
            </p>
          </div>
        ...
        <p className="mt-4 rounded-2xl border border-yellow-500/20 bg-yellow-500/10 p-3 text-xs leading-5 text-yellow-50/80">
          Modelo preliminar para estudo e apresentação. A escolha final da bomba
          deve ser confirmada em catálogo oficial e com dimensionamento completo.
        </p>
      </section>
    </div>
  );
